...
document.querySelector("link[rel~='icon']").href = 'https://i.postimg.cc/3Nnmx5HD/imagem-2025-02-10-180430841.png';
...
.then(async () => {
    ...
    sendToast("Bem vindo ao Lunaris");
