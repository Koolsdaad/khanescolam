...
.then(async () => {
    ...
    sendToast("só me chama se realmente precisar ok?");
    
    playAudio('https://r2.e-z.host/4d0a0bea-60f8-44d6-9e74-3032a64a9f32/gcelzszy.wav');
    
    await delay(500);
    
    sendToast(`olha quem voltou ${user.nickname}`);
